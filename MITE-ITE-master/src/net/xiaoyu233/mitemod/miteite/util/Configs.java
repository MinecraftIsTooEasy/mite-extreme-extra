...
public class Configs {
    ...
    public static class wenscConfig {
        ...
        public static ConfigItem <Double> steppedMobDamageFactor = new ConfigItem("steppedMobDamageFactor", 0.5d, "渐进伤害每次增幅点数基础值(小数)", 0d ,100d);
        public static ConfigItem <Double> steppedMobDamageProgressMax = new ConfigItem("steppedMobDamageProgressMax", 2d, "怪物对玩家渐进伤害增幅最大值(小数)", 0d,100d);
        ...
        public static ConfigItem <Integer> silverFrequencyOverworld = new ConfigItem("silverFrequencyOverworld", 10, "主世界银矿生成频率", 0 ,100);
        public static ConfigItem <Integer> ironFrequencyOverworld = new ConfigItem("ironFrequencyOverworld", 40, "主世界铁矿生成频率", 0 ,100);
        public static ConfigItem <Integer> goldFrequencyOverworld = new ConfigItem("goldFrequencyOverworld", 20, "主世界金矿生成频率", 0 ,100);
        public static ConfigItem <Integer> mithrilFrequencyOverworld = new ConfigItem("mithrilFrequencyOverworld", 10, "主世界秘银矿生成频率", 0 ,100);
        public static ConfigItem <Integer> lapisFrequencyOverworld = new ConfigItem("lapisFrequencyOverworld", 4, "主世界青金石矿生成频率", 0 ,100);
        public static ConfigItem <Integer> diamondFrequencyOverworld = new ConfigItem("diamondFrequencyOverworld", 5, "主世界钻石矿生成频率", 0 ,100);
