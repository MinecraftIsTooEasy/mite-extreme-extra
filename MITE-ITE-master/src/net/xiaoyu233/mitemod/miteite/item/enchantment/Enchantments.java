...
//    public static final Enchantment DEFENCED = new EnchantmentDefence(getNextEnchantmentID(), yq.c,20);
    ...
    public static final Enchantment enchantmentSlowdown = new EnchantmentSlowdown(getNextEnchantmentID(), yq.d,30);
    public static List<Enchantment> individualEnchantments = new ArrayList<>();
    public static void registerEnchantments(){
        Enchantments.registerEnchantmentsUnsafe(enchantmentFixed, CRIT, EXTEND, EMERGENCY, CONQUEROR, BEHEADING, enchantmentChain, enchantmentSlowdown);
    }
